...
-- -----------------------------------------------------
-- Table `trekking`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `trekking`.`Usuario` (
...
-- -----------------------------------------------------
-- Table `trekking`.`Caminata`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `trekking`.`Caminata` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Caminata_Usuario`
    ...
    REFERENCES `trekking`.`Usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
